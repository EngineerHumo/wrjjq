...
from redraw_saved_trajectories import DEFAULT_OUTPUT_DIR, MAX_STEPS, REPO_ROOT, redraw_network
...
def main():
    ...
    summary = redraw_network(network_name, args.output_dir, args.max_steps)
    print("\n[SUMMARY]")
